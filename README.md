...
<A href="https://youtu.be/TSEEqI3S_zQ" target="_blank">デモ動画へのリンク</A><BR>
...
## グラフの歪みについて
  画面が消えている時にボタンを押した時や、CO2通知が表示された時にCO2/TVOCグラフが急に下がる場合がありますが、これはセンサーに供給される電圧が変動した為です。
  ...
  <img src="image/graph3.JPG" width="320">&emsp;
